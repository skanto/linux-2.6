...
#define	TM_EFDC_DI_COUNT	32		// amount of digital inputs
#define	TM_EFDC_SW_COUNT	10		// state of switches
#define	TM_EFDC_DO_COUNT	32		// amount of digital outputs
#define	TM_EFDC_DO_PWM_NBITS	32		// amount of bits in PWM value
...
typedef volatile struct tm_efdc_gpio {
  ...
  __u32		DI_Pulses[TM_EFDC_DI_COUNT];	// number of pulses detected in inputs (R/)
  __u16		DI_OnDelay[TM_EFDC_DI_COUNT];	// input active delay in ms (R/W)
  __u16		DI_OffDelay[TM_EFDC_DI_COUNT];	// input passive delay in ms (R/W)
  ...
  __u32		DO_PWM[TM_EFDC_DO_COUNT];	// PWM-values (32-bit)
